...
class PostController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if(count($posts) <= 0 ){
            Flash::warning('Nenhum post cadastrado!');
        }
    ...
    {
        $categorias = Categoria::all()->pluck('titulo','id')->toArray();
    ...
    public function store(CreatePostRequest $request)
    {
        ...
        $input['banner'] = $this->Base64ToUrl($request->banner);
        $input['image'] = $this->Base64ToUrl($request->image);
